...
<h3>TERMS OF USE</h3>
<p>
By accessing or using www.obsidianwow.com (the "Site") and affiliated services (the "Services") that belongs to Warcry WoW (Warcry), you (the "User") agree to comply with the terms and conditions governing the User's use of any areas of the Site and affiliated services as set forth below.
</p>
<h3>USE OF SITE</h3>
<p>
