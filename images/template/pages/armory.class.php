...
class Armory_Character extends Armory
{
	...
	{
		$this->setCharDb(new Character_Database(array('host' => 'localhost','username' => 'root',''=>'',ucfirst('character') => 'characters')));
		$this->setWorldDb(new World_Database(array('host' => 'localhost','username' => 'root',''=>'',ucfirst('world') => 'world')));
