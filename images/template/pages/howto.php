                ...
                <div id="accordion">
	            	...
	            	<ul class="howto-row">
	                    ...
	                    <li class="howto-row-content">
	                        ...
	                        <p>5. Replace the text inside with "<span>set realmlist logon.obsidianwow.com</span>" then save.</p>
                    ...
                    <ul class="howto-row">
	                    ...
	                    <li class="howto-row-content">
                            ...
                            <br/>
                            <img src="http://s26.postimg.org/7f77avydl/ts2.png" style=" border-radius:8px;" />
                            <br/><br/>
                           ...
                           <br/>
                           <img src="http://s26.postimg.org/t30qz2o5l/ts4.png" style=" border-radius:8px;" />
                           <br/><br/><br/>
                           
                           <p><b>4.</b> Then fill in all the information that was given bellow. For your Username put in what ever you want (But better use your website Display Name). <br/><br/> IP: <b>195.154.204.63</b><br/>Password: <b>There is no password!</b></p>
                           <br/>
                           <img src="http://s26.postimg.org/rchpxl6mh/ts5.png" style=" border-radius:8px;" />
                           <br/><br/>
	                ...
	                <ul class="howto-row">
	                    ...
	                    <li class="howto-row-content" style="display:none">
	                    	...
	                    	<p><b>4. <font color="#ad8c47">Email</font></b></p>
	                            ...
	                            <br/><br/>
	                            Make sure your email is active and accepts messages from @obsidianwow.com.
		                        </p>
	                        ...
	                        <p><b>4. <font color="#ad8c47">Sharing account information</font></b></p>
	                            ...
	                            <br/><br/>
	                            2. Trying to trade your account is another stupid idea. First of all, if you think you can earn some money using obsidianwow 
	                            server you need to think again. The person who are you trying with can simply screenshot conversation which will 
	                            lead to your account permament suspenion. Trading accounts on obsidianwow  is general not even possible because 
