...
<meta name="Keywords" content="Warcry, obsidianwow, Warcry WoW, WoW, World of Warcraft, Warcraft, wotlk, Wrath of the Lich King, wotlk server, Private Server, Private WoW Server, WoW Server, WoW Private Server, win a character, splash, splash page, reward, rewards">
<meta name="language" content="English">
<meta name="type" content="website">
<meta name="copyright" content="Copyright www.obsidianwow.com">
<meta name="resource-type" content="games">
<meta name="Distribution" content="Global">
<meta name="email" content="webmaster@obsidianwow.com">
...
<meta name="DC.Rights" content="(c) obsidianwow.com all rights reserved.">
 ...
 <div id="header" align="center">
   <div class="holder">
        ...
        <ul class="top-navigation">
                ...
                <p></p>
                	<div class="nddm-holder" align="center">
		                <div class="navi-dropdown">
                            ...
                            <span><a href="<?php echo $config['BaseURL']; ?>/forums.php?page=forum&id=17">Support</a></span>
            ...
            <li>
            	<a id="features" href=""><p></p></a>
                <p></p>
                	<div class="nddm-holder features" align="center">
		                <div class="navi-dropdown">
	                    	
							<span><a href="<?php echo $config['BaseURL']; ?>/index.php?page=features">Online Players</a></span>
...
<div id="image_header" align="center">
	...
	if (defined('is_forums'))
	{
		...
		<div class="sub_head_image" align="center">
			...
			//Select random image
			$HeaderImages = array(
				'template/style/images/background.png',
				'template/style/images/background.png',
				'template/style/images/background.png',
				'template/style/images/background.png',
				'template/style/images/background.png',
	...
	else
	{
		if ($TPL->GetParameter('slider'))
		{
			...
			$(document).ready(function()
			{
				$("#html5-video").videoBG(
				{
					mp4: "http://obsidianwow.com/movies/cwc.mp4",
					ogv: "http://obsidianwow.com/movies/cwc.ogv",
					webm: "http://obsidianwow.com/movies/cwc.webm",
					poster: "http://obsidianwow.com/movies/cwc.jpg",
					scale: true,
					loop: "loop",
					zIndex: 0
				});
